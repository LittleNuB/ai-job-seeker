...
- 6 问从“小 C 固定作答”变为“用户作答，可使用演示答案作为参考”。
...
2. 用户背景输入最小化：把小 C 示例变成可填充样例，支持真实用户输入。
